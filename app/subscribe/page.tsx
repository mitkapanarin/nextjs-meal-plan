...
export default function SubscribePage() {
  ...
  return (
    <div className="px-4 py-8 sm:py-12 lg:py-16">
      ...
      {/* Section Header */}
      <div>
        <h2 className="text-3xl text-gray-800 font-bold text-center mt-12 sm:text-5xl tracking-tight">
          Pricing
        </h2>
        <p className="max-w-3xl text-gray-800 mx-auto mt-4 text-xl text-center">
          Get started on our weekly plan or upgrade to monthly or yearly when
          you’re ready.
        </p>
      </div>
      {/* Cards Container */}
      <div className="mt-12 container text-gray-800 mx-auto space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
